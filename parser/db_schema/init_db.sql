...
-- subconnections.sql
DROP VIEW IF EXISTS net.display_subconnections;
DROP VIEW IF EXISTS net.subconnections;
DROP VIEW IF EXISTS net.mv_packets_to_subconnections;
DROP TABLE IF EXISTS net.subconnections_state;

CREATE TABLE net.subconnections_state
(
    src_mac FixedString(6),
    dst_mac FixedString(6),
    src_ip IPv6,
...
CREATE MATERIALIZED VIEW net.mv_packets_to_subconnections
