...
SELECT
    ...
    arrayDistinct( arrayMap(m -> lower(hex(m)), groupUniqArrayMerge(node_a_macs_state)) ) AS node_a_macs,
    arrayDistinct( arrayMap(m -> lower(hex(m)), groupUniqArrayMerge(node_b_macs_state)) ) AS node_b_macs
