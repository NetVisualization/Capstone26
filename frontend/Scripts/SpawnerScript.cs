...
//    void MakeNodes()
//    {
//        foreach (DBConnection.Node node in dbConnection.nodes)
//        {
//            if (node.IPaddr != null)
//            {
//                if (!NodeObjects.ContainsKey(node._id.oid))
//                {
//                    // Create a new GameObject based on the prefab
//                    GameObject nodeObject = Instantiate(NodePrefab);

//                    nodeObject.GetComponent<NodeData>().Id = node._id.oid;
//                    nodeObject.GetComponent<NodeData>().MACAddress = node.MACaddr;
